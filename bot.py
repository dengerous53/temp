    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("⚡ 𝖢𝖫𝖨𝖢𝖪 𝖳𝖮 𝖢𝖮𝖭𝖭𝖤𝖢𝖳 ⚡", url="https://shorturllink.in/member/tools/bookmarklet")
                    ],
                    [
                        InlineKeyboardButton("❓ 𝖧𝖮𝖶 𝖳𝖮 𝖢𝖮𝖭𝖭𝖤𝖢𝖳 ❓", url="https://shorturllink.in/member/tools/bookmarklet")
                    ],
                    [
                        InlineKeyboardButton("⚙️ ʜᴏᴡ ᴛᴏ ᴜsᴇ ⚙️", url="https://shorturllink.in/member/tools/bookmarklet")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if not user["shortener_api"]:
            return await message.reply_text(f"𝗙𝗜𝗥𝗦𝗧 𝗖𝗢𝗡𝗡𝗘𝗖𝗧 𝗪𝗜𝗧𝗛 𝗬𝗢𝗨𝗥 𝗣𝗟𝗔𝗬𝗗𝗜𝗦𝗞 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗧𝗛𝗘𝗡 𝗨𝗦𝗘 𝗠𝗘\n\n[⚡ 𝖢𝖫𝖨𝖢𝖪 𝖳𝖮 𝖢𝖮𝖭𝖭𝖤𝖢𝖳 ⚡](https://playdisk.xyz/member/dashboard)")
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("⚡ 𝖢𝖫𝖨𝖢𝖪 𝖳𝖮 𝖢𝖮𝖭𝖭𝖤𝖢𝖳 ⚡", url="https://shorturllink.in/member/dashboard")
                    ],
                    [
                        InlineKeyboardButton("❓ 𝖧𝖮𝖶 𝖳𝖮 𝖢𝖮𝖭𝖭𝖤𝖢𝖳 ❓", url="https://shorturllink.in")
                    ],
                    [
                        InlineKeyboardButton("⚙️ ʜᴏᴡ ᴛᴏ ᴜsᴇ ⚙️", url="https://shorturllink.in")
                    ],
                    [
                        InlineKeyboardButton("✅ 𝖠𝖡𝖮𝖴𝖳 𝖡𝖮𝖳 ✅", callback_data="aboutdevs")
                    ]
